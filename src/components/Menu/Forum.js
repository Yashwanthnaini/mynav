        ...
        <div className="wef-0">
            ...
            <div
                ...
                <div className="menu-stack wef-1br6ptk">
                    <Link onClick={() => setSideMenuOpen(false)} className="menu-link wef-k8q6g0" to="/about/missions">
                        Our Mission
                    </Link>                                                                
                    <Link onClick={() => setSideMenuOpen(false)} className="menu-link wef-k8q6g0" to="/about/partners">Our Partners</Link>
                    <Link onClick={() => setSideMenuOpen(false)} className="menu-link wef-k8q6g0" to="/about/governance">
                        Leadership & Governance
                    </Link>  
                    <Link onClick={() => setSideMenuOpen(false)} className="menu-link wef-k8q6g0" to="/about/lifeatftp">
                        Life at FTP
                    </Link>  
                </div>
            </div>
