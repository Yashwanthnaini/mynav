    ...
    return (
        ...
        <div className="Imagebar">
            ...
            <ul className="Topbar__links">
                <Link to="/about/mission" style={{ textDecoration: 'none', color: 'white' }}>
                    <li >Mission</li>
                </Link>
                <Link to="/about/whoweare" style={{ textDecoration: 'none', color: 'white' }}>
                    <li  >Who we are</li>
                </Link>
                <Link to="/about/whatwedo" style={{ textDecoration: 'none', color: 'white' }}>
                    <li  >What we do</li>
                </Link>
                <Link to="/about/howwedo" style={{ textDecoration: 'none', color: 'white' }}>
                    <li  >How we do</li>
                </Link>
                <Link to="/about/governance" style={{ textDecoration: 'none', color: 'white' }}>
                    <li  >Governance & Leadership</li>
                </Link>
                <Link to="/about/finance" style={{ textDecoration: 'none', color: 'white' }}>
                    <li  >Financials and Reports</li>
                </Link>

                <Link to="/about/contact" style={{ textDecoration: 'none', color: 'white' }}>
                    <li  >Contact us</li>
                </Link>
            ...
            <p onClick={() => hideBar()} className="selected"><span className="text">Mission</span><span><img src={arrow} alt={arrow} id="image" /></span></p>
                    <ul className="dropdown__menu" >
                        ...
                        <Link to="/about/whoweare" style={{ textDecoration: 'none' }}>
                            <li  >Who we are</li>
                        </Link>
                        <Link to="/about/whatwedo" style={{ textDecoration: 'none' }}>
                            <li  >What we do</li>
                        </Link>
                        <Link to="/about/howwedo" style={{ textDecoration: 'none' }}>
                            <li  >How we do</li>
                        </Link>
                        <Link to="/about/governance" style={{ textDecoration: 'none' }}>
                            <li  >Governance & Leadership</li>
                        </Link>
                        <Link to="/about/finance" style={{ textDecoration: 'none' }}>
                            <li  >Financials and Reports</li>
                        </Link>
