...
import LeadershipAndGovernance from "./LeadershipAndGovernence/LeadershipAndGovernance.js";
...
const LAndG = () => {
    ...
    const [imageText, setImageText] = useState("Leadership & Governance");

    const [loadPage,setLoadPage] =useState(<LeadershipAndGovernance/>);
        ...
        <ul className="Topbar__links">
            <Link
                ...
                <li
                    ...
                    setImageText("Leadership & Governance");setLoadPage(<LeadershipAndGovernance />)}}>Leadership & Governance</li>
            </Link>
            <Link
                to="/about/governance/people"
                style={{
                    textDecoration: 'none',
                    color: 'white'
                }}>
        ...
        openDropdown
            ...
            <Link
                ...
                <li onClick={() => {setImageSrc(
                    ...
                    setImageText("Leadership & Governance");setLoadPage(<LAndG />)}}>Leadership & Governance</li>
            </Link>
            <Link
                to="/about/governance/people"
                style={{
