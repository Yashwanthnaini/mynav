...
const Contacts = () => {
    ...
    const [imageText, setImageText] = useState("Contacts");

    const [loadPage,setLoadPage] =useState(<Contact/>);
        ...
        <ul className="Topbar__links">
            <Link
                ...
                <li
                    ...
                    setImageText("Contacts");setLoadPage(<Contact />)}}>Contacts</li>
            </Link>
            <Link
                to="/contacts/people"
                style={{
