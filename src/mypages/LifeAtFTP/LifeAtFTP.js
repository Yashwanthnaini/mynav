...
import AtFTP from "./AtFTP/AtFTP.js";
...
const LifeAtFTP = () => {
    ...
    const [imageText, setImageText] = useState("Life At ftp");

    const [loadPage,setLoadPage] =useState(<AtFTP/>);
        ...
        <ul className="Topbar__links">
            <Link
                ...
                <li
                    ...
                    setImageText("Life At ftp");setLoadPage(<AtFTP />)}}>Life At FTP</li>
            </Link>
            <Link
                to="/about/lifeatftp/people"
                style={{
                    textDecoration: 'none',
                    color: 'white'
                }}>
