...
const Partners = () => {
    ...
    const [imageText, setImageText] = useState("Our Partners");

    const [loadPage,setLoadPage] =useState(<Partner/>);
        ...
        <ul className="Topbar__links">
            <Link
                ...
                <li
                    ...
                    setImageText("Our Partners");setLoadPage(<Partner />)}}>Our Partners</li>
            </Link>
            <Link
                to="/about/partners/people"
                style={{
                    textDecoration: 'none',
                    color: 'white'
                }}>
