...
const Projects = () => {
    ...
    const [imageText, setImageText] = useState("Projects");

    const [loadPage,setLoadPage] =useState(<Project />);
        ...
        <ul className="Topbar__links">
            <Link
                ...
                <li
                    ...
                    setImageText("Projects");setLoadPage(<Project />)}}>Projects</li>
            </Link>
            <Link
                to="/projects/people"
                style={{
